...
class Slider_image extends StatefulWidget {
  Slider_image({Key? key}) : super(key: key);
  ...
  @override
  State<Slider_image> createState() => _Slider_imageState();
}

class _Slider_imageState extends State<Slider_image> {
  int activeIndex = 0;
